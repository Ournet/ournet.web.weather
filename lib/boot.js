...
module.exports = function (req, res, next) {
	if (req.hostname === 'www.moti2.al') {
		return res.redirect(301, 'http://moti2.al' + req.originalUrl);
	}
	if (req.hostname === 'www.hava.one') {
		return res.redirect(301, 'http://hava.one' + req.originalUrl);
	}
