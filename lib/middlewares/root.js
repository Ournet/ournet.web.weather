...
module.exports = function(req, res, next) {
	...
	util.localDate = function(t) {
		var date = new time.Date(t);
		date.setTimezone(config.timezone, true);
		return date;
	};
	...
	var currentDate = res.locals.currentDate = util.localDate();

	var currentDateNoTime = res.locals.currentDateNoTime = util.localDate();
