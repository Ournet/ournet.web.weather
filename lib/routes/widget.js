...
route.get('/widget/widget_html_script', function(req, res) {
  ...
  var data = ['<!-- ' + config.name + ' Weather Widget -->',
    '<ins class="ournetweather" style="display:inline-block;max-width:' + width + 'px;height:' + height + 'px" data-type="widget" data-cn="' + config.country + '" data-params="' + params + '" data-h="' + height + '"></ins>',
