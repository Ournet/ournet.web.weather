...
route.get('/widget2/widget_html_script', function(req, res) {
  ...
  var data = ['<!-- ' + config.name + ' Weather Widget -->',
    '<ins class="ournetweather" style="display:inline-block;max-width:' + req.query.w + 'px;height:' + formatter.iframeHeight + 'px" data-cn="' + config.country + '" data-params="' + params + '" data-h="' + formatter.iframeHeight + '"></ins>',
