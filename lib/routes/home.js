...
route.get('/', function(req, res, next) {
  ...
  res.locals.title = res.locals.site.head.title = util.format(__('weather.home_title_format'), places.util.inCountryName(currentCulture.countryName, currentCulture.language));
